                            ...
                            {seatingPlans.map(plan => (
                                <div
                                    ...
                                    style={{
                                        ...
                                        background: String(roomNumber).trim() === String(plan.roomNumber).trim() ? 'rgba(var(--primary-rgb), 0.1)' : 'var(--background-color)',
                                        borderColor: String(roomNumber).trim() === String(plan.roomNumber).trim() ? 'var(--primary-color)' : 'var(--border-color)',
                                        cursor: 'pointer',
